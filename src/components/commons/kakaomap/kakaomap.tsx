...
export default function KakaoMapPage(props: KakaomapProps): JSX.Element {
  useEffect(() => {
    ...
    script.onload = () => {
      window.kakao.maps.load(function() {
        ...
        // 마커가 표시될 위치입니다 
        const markerPosition  = new window.kakao.maps.LatLng(props.lat, props.lng); 
  ...
  return (
    <>
      <div id="map" style={{width: '100%', height: '400px', marginTop: "50px"}}></div>
    </>    
  );
}