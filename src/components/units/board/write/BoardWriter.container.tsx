...
const BoardsWriteContainer = (props: IBoardWritePropsUI): JSX.Element => {
  ...
  const onChangeWriter = (e: ChangeEvent<HTMLInputElement>) => {
    e.target.value && watch("password") && watch("title") && watch("contents")
      ? setIsActive(false)
      : setIsActive(true);
  };
  const onChangePassword = (e: ChangeEvent<HTMLInputElement>) => {
    e.target.value && watch("writer") && watch("title") && watch("contents")
      ? setIsActive(false)
      : setIsActive(true);
  };
  const onChangeTitle = (e: ChangeEvent<HTMLInputElement>) => {
    e.target.value && watch("password") && watch("writer") && watch("contents")
      ? setIsActive(false)
      : setIsActive(true);
  };
  const onChangeContents = (e: ChangeEvent<HTMLTextAreaElement>) => {
    e.target.value && watch("password") && watch("title") && watch("writer")
      ? setIsActive(false)
      : setIsActive(true);
  };
...
export default withAuth(BoardsWriteContainer);
